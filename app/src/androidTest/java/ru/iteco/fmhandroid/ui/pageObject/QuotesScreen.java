...
public class QuotesScreen {
    ...
    public String descriptionText(int position) {return DataHelper.Text.getText(onView(withIndex(withId(R.id.our_mission_item_description_text_view), position))).replaceAll("^\"|\"$", "");
    }
